    ...
    <header>
        <div class="navwrapper">
            ...
            <ul class="navbar">
                ...
                <li id="a-login"><a href="role-login.php">LOG IN</a></li>
            </ul>
        </div>
    </header>
    <main>
        <div class="form-container">
            <h3 class="admin-msg">Admin Login</h3>
            <form action="php-script/admin-login-script.php" method="POST">
                <div class="input-container">
                    <i class="fa fa-user icon"></i>
                    <input type="text" name="name" class="input-field" placeholder="Username/Email" />
                </div>
                <div class="input-container">
                    <i class="fa fa-key icon"></i>
                    <input type="password" name="pwd" class="input-field" placeholder="Password" id="pwd-input" />
